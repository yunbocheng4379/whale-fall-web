        ...
        >
          <div>
            ...
            <div style={{ color: '#8c8c8c', marginTop: 8 }}>
              总计：<strong>{libraries.length}</strong> 个文库&nbsp;&nbsp;
              文档：
              <strong>
                {libraries.reduce((s, l) => s + (l.fileCount || 0), 0)}
              </strong>{' '}
              个
            </div>
          </div>
            ...
            libraries.map((lib) => (
              <Col key={lib.id} xs={24} sm={12} md={8} lg={8}>
                ...
                >
                  ...
                  <div
                    style={{ color: '#8c8c8c', fontSize: 12, marginTop: 12 }}
                  >
                    {lib.fileCount || 0} 文档 · 更新：
                    {lib.updateTime ? lib.updateTime.split('T')[0] : '-'}
                  </div>
                  <div
                    style={{ borderTop: '1px solid #f0f0f0', marginTop: 12 }}
                  />
                  <div
                    style={{
                      display: 'flex',
                    ...
                    <div style={{ flex: 1 }}>
                      <Button
                        ...
                        style={{
                          ...
                          height: 36,
                          background:
                            'linear-gradient(180deg, #87a9ff, #5b8cff)',
                          border: 'none',
                          color: '#fff',
                          fontWeight: 500,
                        }}
        ...
        >
          <Form form={form} layout="vertical" onFinish={handleCreate}>
            <Form.Item
              ...
              name="name"
              rules={[
                { required: true, message: '请输入知识库名称（支持中文）' },
              ]}
            >
              <Input
                maxLength={100}
