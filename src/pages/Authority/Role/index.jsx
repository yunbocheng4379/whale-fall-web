  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        return <Tag color={record.role === 'admin' ? 'red' : record.role === 'tester' ? 'blue' : 'green'}>{role?.label}</Tag>;
      },
    },
    {
      title: '创建时间',
      ...
      render: (_, record) => record.createTime ? moment(record.createTime).format('YYYY-MM-DD HH:mm:ss') : '-',
    },
    {
      title: '操作',
      valueType: 'option',
